...
using Plots; gr()
using Test
using StatisticsWithJulia: generate_data
using StatisticsWithJulia: create_bins
using StatisticsWithJulia: compute_histogram
using StatisticsWithJulia: plot_histogram
