...
using LaTeXStrings
using Plots; gr()
# In line 3, we define the function f2().
...
# for each progressively larger interval up to the specified value x. The total area is then approximated via the sum() function.
