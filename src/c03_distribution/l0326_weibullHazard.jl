...
# Note the type speciﬁcation ::Weibull and the use of the shape() and scale() functions.
...
function main_l0326_weibullHazard()
    ...
    # create Figure of Hazard rate functions for diﬀerent Weibull distributions.
    Cl = [:blue :red :green]
