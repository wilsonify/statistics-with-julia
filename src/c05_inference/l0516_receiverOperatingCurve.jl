...
@testset "end_to_end" begin
    ...
    plot(falsePositive, [truePositiveA truePositiveB truePositiveC],    c = [:blue :red :green],    label = [L"H1a: \mu_1 = 16" L"H1b: \mu_1 = 18" L"H1c: \mu_1 = 20"])
    plot!([0, 1], [0, 1], c = :black, ls = :dash, label = "H0 = H1 = 15",    xlims = (0,1), ylims = (0,1), xlabel = L"\alpha", ylabel = "Power",    ratio = :equal, legend = :bottomright)
end
